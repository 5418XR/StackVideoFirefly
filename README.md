...
The application collects the light emitted by each individual firefly from videos. It then accumulates this light over time to create a comprehensive dataset that represents the collective luminosity of the fireflies.
